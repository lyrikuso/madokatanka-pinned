  ...
  <div>
    ...
    <section>
      <div>
        ...
        <ul>
          <li>
            投稿された作品は匿名で公開されます。作品を投稿することで、サイト利用者はまどか短歌会が作品を匿名で公開することに同意したものと見なします。
          </li>
          <li>
            個人情報や誹謗・中傷、その他の他者の権利を侵害したり法律に触れたりすると考えられる文言は、サイト管理者の判断で削除することがあります。また、これらの例に限らず、作品はサイト管理者の判断で削除することがあります。
          </li>
          <li>
            過去に公開した作品でも投稿することができます。ただし、まどか短歌会に投稿された特定の作品について自分の作品であると発信することはお控えください。
          </li>
        </ul>
      </div>
      <form @submit.stop>
        <div>
          ...
          <textarea
            v-model.trim="text"
            placeholder="140字まで（長すぎると正しく表示されないことがあります）"
            rows="5"
            minlength="1"
            maxlength="140"
            name="textarea"
        ...
        <vs-row vs-w="12">
          <vs-col
            ...
            vs-sm="12"
          >
            <vs-checkbox v-model="rule"
              >投稿におけるルールに同意する</vs-checkbox
            >
          </vs-col>
          <vs-col
            vs-type="flex"
      ...
      <div>
        <h3>プレビュー</h3>
        <div is="slide" :item.sync="item"></div>
      </div>
      <div>
        <h3>利用できる記法</h3>
