...
<div>
    ...
    <section>
        ...
        <form @submit.stop>
            ...
            <textarea v-model.trim="text" placeholder="IDはひとつずつ報告してください" rows="1" minlength="1" maxlength="24"></textarea>
            <vs-row vs-w="12">
                <vs-col vs-type="flex" vs-justify="flex-end" vs-align="flex-start" vs-offset="8" vs-lg="4" vs-sm="12">
        ...
        post () {
            if (!this.$v.text.$invalid) {
                ...
                .catch(error => {
                    ...
                    this.$vs.notify({
                        time: 4000,
                        title: "うまく報告できませんでした。あとでもう一度お試しください",
                        text: "",
                        color: "warning",
                        icon: "info"
                    })
